...
//    }
    ...
    [self addExampleTextWithRenderedEquation];
...
- (void)addExampleTextWithRenderedEquation {
    
    NSMutableAttributedString *text = [NSMutableAttributedString new];
    UIFont *font = [UIFont systemFontOfSize:16];
    
    [text appendAttributedString:[[NSAttributedString alloc] initWithString:@"Your problem is to solve this equation: " attributes:nil]];
    ...
    NSMutableAttributedString *attachText = [NSMutableAttributedString yy_attachmentStringWithContent:testLabel contentMode:UIViewContentModeCenter attachmentSize:CGSizeMake(testLabel.frame.size.width, testLabel.frame.size.height) alignToFont:font alignment:YYTextVerticalAlignmentCenter];
    [text appendAttributedString:attachText];
    [text appendAttributedString:[[NSAttributedString alloc] initWithString:@" How would you solve this equation and what methods would you use?" attributes:nil]];
    
    YYLabel *label = [[YYLabel alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, 100)];
